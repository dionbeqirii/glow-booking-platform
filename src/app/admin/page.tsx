...
export default async function AdminPage() {
  ...
  const [
    ...
    prisma.booking.findMany({ where: { startTime: { gte: from14, lte: now } }, select: { startTime: true } }),
          ...
          <Panel title="Përmbledhje" hint="30 ditët e fundit" className="lg:col-start-3 lg:row-start-1">
            <ul className="space-y-3">
              ...
              <li className="flex items-center justify-between">
                ...
                <span className="font-semibold text-ink">{stats.queue.avgWaitMin === null ? "—" : `${stats.queue.avgWaitMin} min`}</span>
              </li>
              <li className="flex items-center justify-between">
                  ...
                  return (
                    <li key={u.staffId}>
                      <div className="mb-1 flex justify-between text-sm">
                        ...
                        <span className="text-ink-soft">{pct(u.utilization)}</span>
                      </div>
