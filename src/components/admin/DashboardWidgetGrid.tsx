    ...
    <div className="space-y-6">
      ...
      {modalOpen &&
        ...
        createPortal(
          ...
          >
            <div className="flex max-h-[85vh] w-full max-w-md flex-col rounded-2xl bg-surface/80 shadow-[0_24px_60px_-20px_rgba(43,38,34,0.55)] ring-1 ring-white/60 backdrop-blur-2xl">
