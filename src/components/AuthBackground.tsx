...
export const authInput =
  "glass-input w-full rounded-xl border border-white/50 bg-white/25 px-3.5 py-2.5 text-sm text-ink outline-none backdrop-blur-sm transition-colors placeholder:text-ink-soft focus:border-white/80 focus:bg-white/35 focus:ring-2 focus:ring-white/30";
