...
export default function MobileNav({ role }: { role: string }) {
  ...
  return (
    <div className="relative lg:hidden" ref={boxRef}>
      ...
      {open && (
        <div className="absolute right-0 top-11 z-40 w-56 overflow-hidden rounded-2xl bg-surface p-1.5 shadow-[0_18px_45px_-18px_rgba(43,38,34,0.5)] ring-1 ring-line">
          {tabs.map((t) => {
